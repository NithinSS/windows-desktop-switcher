...
<#!::JustMoveCurrentWindowToDesktop(1)
<#@::JustMoveCurrentWindowToDesktop(2)
<##::JustMoveCurrentWindowToDesktop(3)
<#$::JustMoveCurrentWindowToDesktop(4)
<#%::JustMoveCurrentWindowToDesktop(5)
<#^::JustMoveCurrentWindowToDesktop(6)
<#&::JustMoveCurrentWindowToDesktop(7)
<#*::JustMoveCurrentWindowToDesktop(8)
